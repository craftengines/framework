...
> **⚠️ Aspirational target design, not the current implementation.**
> This document describes a vision for Craft — including details (FastAPI,
> asyncpg, SQLAlchemy 2.0 Core, Pydantic v2) that do **not** match what is
> actually built. The real implementation is Starlette-based, synchronous,

...
@section("content")
    ...
    <div class="hero-section">
        ...
        <div class="hero-content">
            ...
            <h1 class="hero-title">
                Craft Engine <sup class="hero-version">{{ config('app.version') }}</sup>
            </h1>
            ...
            <div class="hero-stats">
                <div class="stat-item">
                    <span class="stat-value">596</span>
...
Route.get(<span class="code-string">"/dashboard"</span>, [HomeController, <span class="code-string">"index"</span>])
    ...
    <section class="section-features" id="features">
        <div class="section-container">
            <div class="section-header">
                <span class="section-tag">Why Craft Engine?</span>
        ...
        <div class="section-container">
            <div class="cards-grid">
                ...
                <a href="/docs/testing" class="action-card" id="card-contribute">
                    ...
                    <p>596 tests across SQLite, PostgreSQL and the minimum Python version.</p>
                </a>
            </div>
        </div>
    </section>

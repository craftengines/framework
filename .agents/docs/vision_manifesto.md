# Craft: The AI-Native Framework of the Future

**Craft** is a Python backend framework built on Starlette, designed to be **AI-Native** rather than just AI-friendly. It pairs clean conventions, a complete CLI and an Active Record ORM with the performance, async model and type safety of modern Python.
...
* **Frontend Scaffold Bridge:** CLI commands in `dev.py` to automatically generate Next.js/React dashboard pages mapping to the backend modules.
